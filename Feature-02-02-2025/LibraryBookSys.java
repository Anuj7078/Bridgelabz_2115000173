import java.util.*;
public class LibraryBookSys{
       String title;
       String author;
       int price;
       int availability;
       public LibraryBookSys(String title, String author, int price, int availability){
             this.title=title;
             this.author=author;
             this.price=price;
       ...
       public static void main(String args[]){
            ...
            LibraryBookSys obj1=new LibraryBookSys(title,author,price,availability);
            obj1.borrowBook();
            sc.close();
       }
}
